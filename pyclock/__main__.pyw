...
def draw(analog_clock):
    ...
    pygame.draw.line(screen, red, analog_clock.center, analog_clock.second_hand_end_position, 1)

    # draw the minute hand
    pygame.draw.line(screen, black, analog_clock.center, analog_clock.minute_hand_end_position, 5)

    # draw the hour hand
    pygame.draw.line(screen, black, analog_clock.center, analog_clock.hour_hand_end_position, 5)

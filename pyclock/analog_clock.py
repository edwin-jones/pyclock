...
class AnalogClock:
    ...
    _second_angle = 0
    _minute_angle = 0  
    _start_hand_end_position = Vector2(0, -150) # 150 will be the length of a hand in pixels by default!
    ...
    def update(self, delta_time):
        ...
        self.minute_hand_end_position = self.minute_hand_end_position + self._center
